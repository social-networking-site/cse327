			...
			<div class="l_pass">
				<form action="" method="post">
					<div class="input-group">
						<span class="input-group-addo"><i class="glyphicon glyphicon-user"></i></span>
						<input class="form-control" id="email" type="email" name="email" placeholder="Enter Your Email" required>
					</div><br>
					<hr>
					<pre class="text">Enter Your Friend Name</pre>
					<div class="input-group">
						<span class="input-group-addo"><i class="glyphicon glyphicon-pencil"></i></span>
