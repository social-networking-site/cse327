...
<body>
	...
	<div class="row">
			<div class="col-sm-6" style="left: 0.5%;">
				<img src="images/imghome.jpg" class="img-rounded" title="Social Network" width="650px" height="565px">	
				...
				<div id="centered2" class="centered"><h3 style="color: white;"><span class="glyphicon glyphicon-search"></span>&nbsp&nbsp<strong>What People are talking about.</strong></h3></div>		
			...
			<div class="col-sm-6" style="left: 8%">
				<img src="images/imghome2.jpg" class="img-rounded" title="Social Network" width="80px" height="80px">
				<h2><strong>See what's happening in <br> the world right now</strong></h2><br><br>
				<h4><strong>Join Social Network.</strong></h4>
